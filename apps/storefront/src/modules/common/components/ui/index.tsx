  ...
  (
    ...
    return (
      <button
        ...
        className={clsx(
          "inline-flex gap-2 items-center justify-center font-medium tracking-[0.12em] uppercase text-[12.5px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50",
          variant === "primary" && "bg-accent text-white hover:bg-burgundy-dark",
          variant === "secondary" &&
            "bg-white text-ink border border-bronze-200 hover:border-accent hover:text-accent",
          variant === "transparent" && "bg-transparent hover:bg-cream-200",
